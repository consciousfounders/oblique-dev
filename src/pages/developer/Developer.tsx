...
import { Key, Webhook, Code, FileText, AppWindow, BarChart3, Download } from 'lucide-react'
...
type TabValue = 'api-keys' | 'webhooks' | 'oauth-apps' | 'explorer' | 'docs' | 'analytics' | 'sdks'
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage API access, webhooks, SDKs, and explore the API
        </p>
      </div>

      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as TabValue)}>
        <TabsList className="flex gap-1 p-1 bg-muted rounded-lg w-fit flex-wrap">
          <TabsTrigger
            value="api-keys"
        ...
        <div className="mt-6">
          ...
          <TabsContent value="sdks" className="focus:outline-none">
            <SDKDownloads />
          </TabsContent>
        </div>
      </Tabs>
